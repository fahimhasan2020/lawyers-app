import {StyleSheet, Text, View, Image, Pressable,Share,Linkin, Linking} from 'react-native';
...
const Profile = () => {
  ...
  const handleShare = ()=>{
    const message = "Hello! please download ukilvai app from store. https://play.google.com/store/apps/details?id=com.sf.ukilvai.lawyerapp"
    Share.share({message:message});
  }
  const handleOpen = ()=>{
    Linking.openURL('https://play.google.com/store/apps/details?id=com.sf.ukilvai.lawyerapp');
  }
  return (
    <DrawerContainer showGear={true}>
      <View style={styles.container}>
        ...
        <View style={styles.navigationsContainer}>
          <Pressable
            ...
            style={styles.menus}>
            <Text style={styles.navigationText}>Profile update</Text>
            <AntDesign
              name="tool"
              size={25}
              style={{opacity: 0.6}}
          ...
          <Pressable onPress={handleShare} style={styles.menus}>
          ...
          <Pressable onPress={handleOpen} style={styles.menus}>
      ...
      <BasicModalPopup
        ...
        title="Warning!"
        body="Are you sure? do you want to delete this account?"
        permission={true}
